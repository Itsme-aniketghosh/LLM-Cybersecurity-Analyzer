...
**Cybersecurity Analyzer** is a full-stack, AI-powered web application for analyzing **Python code security vulnerabilities** using **OpenAI Agents** and **Semgrep**.
This project was built by **Aniket Ghosh** following the instructions and curriculum from **Ed Donner’s *AI in Production* course**, and is designed to be cloned and deployed by thousands of students across multiple platforms.
